...
def test_ex10(driver):
    ...
    r, g, b = ast.literal_eval(main_price_color.strip("rgba"))
    if not (r==g==b):
    ...
    r, g, b = ast.literal_eval(main_sale_color.strip("rgba"))
    if not (g==0 and b==0):
    ...
    r, g, b = ast.literal_eval(sub_price_color.strip("rgba"))
    if not (r == g == b):
    ...
    r, g, b = ast.literal_eval(sub_sale_color.strip("rgba"))
    if g != 0 and b != 0:
